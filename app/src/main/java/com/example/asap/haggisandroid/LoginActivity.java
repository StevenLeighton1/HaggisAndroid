...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // AutoCompleteTextView name of XML tag and Java Class
        mEmailView = (AutoCompleteTextView) findViewById(R.id.email);

        //some function
        populateAutoComplete();

        //get 'password' field from XML view
        mPasswordView = (EditText) findViewById(R.id.password);
        //set to edit listener, changes on editor action
        ...
        //get login view from XML field
        mLoginFormView = findViewById(R.id.login_form);

        //get progress view from XML
        mProgressView = findViewById(R.id.login_progress);
    }

    private void populateAutoComplete() {

        //checks request contacts
